export const translations = {
  en: {
    ...
    academic: {
      endlessKnowledge: "Knowledge Transfering Section (KTS)",
      trainingProgram: "Academic Training",
      labTraining: "Hands-on Laboratories and Academic Courses",
      ktsTagline: "Sensor Technology Training Program at SuraZense",
      ktsOverviewEyebrow: "Programme Overview",
      ktsOverviewTitle: "Programme Overview",
      ktsHowDiffer: "How the two parts differ",
      ktsFormat: "Format",
      ktsVenue: "Venue",
      ktsTopics: "Topics",
      ktsLength: "Length",
      ktsGroupSize: "Group Size",
      ktsHandsOnFormat: "Bench work with instruments",
      ktsHandsOnVenue: "Surazense Laboratory",
      ktsHandsOnTopics: "13 laboratories",
      ktsHandsOnLength: "40 hours (Labs 1–9), 20 hours (Labs 10–13)",
      ktsHandsOnGroup: "Up to 12 students",
      ktsHandsOnLead:
      ...
      ktsAcademicFormat: "Seminar and computer-based",
      ktsAcademicVenue: "At your school, on tour, or online",
      ktsAcademicTopics: "9 courses",
      ktsAcademicLength: "3–4 hours each",
      ktsAcademicGroup: "Up to 40 students",
      ktsAcademicLead:
      ...
      ktsPart1: "PART 1",
      ktsPart2: "PART 2",
      ktsGroup1Label: "GROUP 1 · MEDICAL TECHNOLOGY",
      ktsGroup1Title: "Biosensor Engineering & Device Prototyping",
      ktsGroup1Desc:
        "Four sensing platforms, one biomarker. Students detect the same target four different ways, then take the best platform through reuse testing, CAD design, a live web readout, and two wearable devices.",
      ktsGroup2Label: "GROUP 2 · MEDICAL & BIOMEDICAL SCIENCES",
      ktsGroup2Title: "Wet Lab Foundations",
      ktsGroup2Desc:
        "The bench skills every research project assumes. Start here if students have never worked in a controlled laboratory.",
      ktsCoursesBand: "THEORY · CLINICAL CONTEXT · METHODOLOGY",
      ktsCoursesGroupTitle: "Scientific Foundations & Research Methodology",
      ktsCoursesGroupDesc:
        "Courses 1–4 explain why the instruments in Part 1 work and what clinical question they answer. Courses 5–8 turn a student's measurements into a defensible piece of research, and Course 9 is delivered by the Suratec engineering team.",
      ktsContact: "Contact",
      ktsContactName:
        "Dr. Yanwarut Chiraatthakit — Promotion of Education Department, Surazense Co., Ltd.",
      academicCoursesShort: "Academic Courses",
      biotech: "Biotechnology",
      medicalScience: "Medical Science",
      engineering: "Engineering",
      introDesc:
        "The training programme is delivered in two forms. Hands-on Experimental Laboratories put high-school students at a working bench at Surazense Laboratory. Academic Courses build the reasoning around the bench and can be run at your school, on tour, or online.",
  ...
  th: {
    ...
    academic: {
      endlessKnowledge:
        "ฝ่ายถ่ายทอดองค์ความรู้ (Knowledge Transfering Section - KTS)",
      trainingProgram: "หลักสูตรการฝึกอบรมทางวิชาการ",
      labTraining: "ห้องปฏิบัติการภาคปฏิบัติและรายวิชาวิชาการ",
      ktsTagline: "หลักสูตรการฝึกอบรมเทคโนโลยีเซนเซอร์ ณ สุรเซนส์",
      ktsOverviewEyebrow: "ภาพรวมหลักสูตร",
      ktsOverviewTitle: "ภาพรวมหลักสูตรการฝึกอบรม",
      ktsHowDiffer: "สองส่วนนี้ต่างกันอย่างไร",
      ktsFormat: "รูปแบบ",
      ktsVenue: "สถานที่",
      ktsTopics: "หัวข้อ",
      ktsLength: "ระยะเวลา",
      ktsGroupSize: "ขนาดกลุ่ม",
      ktsHandsOnFormat: "ปฏิบัติที่โต๊ะทดลองกับเครื่องมือจริง",
      ktsHandsOnVenue: "ห้องปฏิบัติการ Surazense",
      ktsHandsOnTopics: "13 ห้องปฏิบัติการ",
      ktsHandsOnLength: "40 ชั่วโมง (แล็บ 1–9), 20 ชั่วโมง (แล็บ 10–13)",
      ktsHandsOnGroup: "ไม่เกิน 12 คน",
      ktsHandsOnLead:
      ...
      ktsAcademicFormat: "สัมมนาและใช้คอมพิวเตอร์",
      ktsAcademicVenue: "ที่โรงเรียนของท่าน นอกสถานที่ หรือออนไลน์",
      ktsAcademicTopics: "9 รายวิชา",
      ktsAcademicLength: "วิชาละ 3–4 ชั่วโมง",
      ktsAcademicGroup: "ไม่เกิน 40 คน",
      ktsAcademicLead:
      ...
      ktsPart1: "ส่วนที่ 1",
      ktsPart2: "ส่วนที่ 2",
      ktsGroup1Label: "กลุ่มที่ 1 · เทคโนโลยีทางการแพทย์",
      ktsGroup1Title: "วิศวกรรมไบโอเซนเซอร์และการสร้างอุปกรณ์ต้นแบบ",
      ktsGroup1Desc:
        "แพลตฟอร์มการตรวจวัด 4 รูปแบบ สารบ่งชี้ทางชีวภาพ 1 ชนิด นักเรียนจะได้ตรวจหาเป้าหมายเดียวกันด้วย 4 วิธีการที่แตกต่างกัน จากนั้นนำแพลตฟอร์มที่ดีที่สุดไปทดสอบการนำกลับมาใช้ใหม่ การออกแบบ CAD การแสดงผลแบบเรียลไทม์บนเว็บ และอุปกรณ์สวมใส่ 2 รูปแบบ",
      ktsGroup2Label: "กลุ่มที่ 2 · วิทยาศาสตร์การแพทย์และชีวการแพทย์",
      ktsGroup2Title: "ทักษะพื้นฐานห้องปฏิบัติการวิทยาศาสตร์ (Wet Lab)",
      ktsGroup2Desc:
        "ทักษะการทดลองในห้องแล็บที่จำเป็นสำหรับทุกโครงการวิจัย เริ่มต้นที่นี่หากนักเรียนยังไม่เคยปฏิบัติการในห้องปฏิบัติการควบคุม",
      ktsCoursesBand: "ทฤษฎี · บริบททางคลินิก · ระเบียบวิธีวิจัย",
      ktsCoursesGroupTitle: "รากฐานทางวิทยาศาสตร์และระเบียบวิธีวิจัย",
      ktsCoursesGroupDesc:
        "รายวิชา 1–4 อธิบายหลักการทำงานของเครื่องมือในส่วนที่ 1 และตอบโจทย์คำถามทางคลินิก รายวิชา 5–8 เปลี่ยนผลการวัดของนักเรียนให้กลายเป็นผลงานวิจัยที่น่าเชื่อถือ และรายวิชา 9 บรรยายโดยทีมวิศวกรจาก Suratec",
      ktsContact: "ติดต่อ",
      ktsContactName:
        "ดร.ญาณวรุตม์ จิระอรรถกิจ — ฝ่ายส่งเสริมการศึกษา บริษัท สุรเซนส์ จำกัด",
      academicCoursesShort: "รายวิชาวิชาการ",
      biotech: "เทคโนโลยีชีวภาพ",
      medicalScience: "วิทยาศาสตร์การแพทย์",
      engineering: "วิศวกรรมศาสตร์",
      introDesc:
        "โปรแกรมการฝึกอบรมจัดขึ้นใน 2 รูปแบบ: ห้องปฏิบัติการทดลองภาคปฏิบัติ (Hands-on Labs) ให้นักเรียนได้ลงมือทำจริงบนโต๊ะทดลองที่ห้องปฏิบัติการ Surazense และรายวิชาวิชาการ (Academic Courses) ที่เสริมสร้างกระบวนการคิดและทฤษฎี ซึ่งสามารถจัดอบรมได้ที่โรงเรียนของท่าน นอกสถานที่ หรือผ่านระบบออนไลน์",
      ...
      academicCourses: "รายวิชาวิชาการ",
      academicCoursesDesc:
        "สัมมนาและเซสชันบนคอมพิวเตอร์ที่ให้ทฤษฎี บริบทคลินิก และระเบียบวิธีวิจัย ซึ่งผลจากโต๊ะทดลองต้องมีเพื่อกลายเป็นผลงานวิจัย ไม่จำเป็นต้องมีห้องปฏิบัติการ",
